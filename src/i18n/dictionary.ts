...
export const dictionary: Record<Locale, Messages> = {
  en: {
    ...
    "mascot.hint": "Create it in the Totem. One character, two homes — it also lives in the Garden.",
  ...
  es: {
    ...
    "mascot.hint": "Créalo en el Tótem. Un personaje, dos hogares — también vive en el Jardín.",
